  ...
  return (
    <section className="relative pb-20 ">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <div>
            <div className="inline-flex font-medium bg-clip-text !text-transparent bg-gradient-to-r from-pink-500 to-blue-500 dark:from-pink-500 dark:to-orange-200 pb-3">
