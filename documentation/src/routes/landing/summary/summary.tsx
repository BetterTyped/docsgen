          ...
          <div className="relative pb-12 md:pb-20">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="434" height="427">
                ...
                <path
                  className="dark:fill-blue-700 fill-blue-300"
                  fillRule="evenodd"
            ...
            <Highlighter className="grid md:grid-cols-12 gap-6 group">
              ...
              <FadeIn className="w-[100%] overflow-hidden md:col-span-12" start={0.2} end={0.5} translateY={40}>
                <Link to="/docs/documentation">
                  <HighlighterItem>
                    <div className="relative bg-slate-50 dark:bg-slate-900 h-full rounded-[inherit] z-20 overflow-hidden">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                          ...
                          <div>
                            <div className="btn-sm text-slate-800 hover:text-black dark:text-slate-300 dark:hover:text-white transition duration-150 ease-in-out group dark:[background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] relative before:absolute before:inset-0 dark:before:bg-slate-800/30 before:rounded-full before:pointer-events-none">
                    ...
                    <div className="relative bg-slate-50 dark:bg-slate-900 h-full rounded-[inherit] z-20 overflow-hidden">
                      <div className="flex flex-col">
                        ...
                        <div
                          ...
                          aria-hidden="true"
                        >
                          <div className="absolute inset-0 translate-z-0 bg-slate-300 dark:bg-slate-800 rounded-full blur-[80px]" />
                        </div>
                        {/* Text */}
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h6 className="font-medium text-slate-900 dark:text-slate-50">{feature.name}</h6>
                  </div>
