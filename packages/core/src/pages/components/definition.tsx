...
export const getDefinition = (reflection: JSONOutput.SomeReflection) => {
  const source = "sources" in reflection ? reflection.sources?.[0] : null;
  return source;
};

export const Definition: React.FC<PagePropsType & DefinitionProps> = (props) => {
  ...
  return (
    <div className={`api-docs__definition api-docs__details ${className}`}>
      <div className="api-docs__label">Source</div>
      ...
      <div className="api-docs__info">
        <a href={source.url}>View the source code</a>
      </div>
    </div>
  );
};
